var arguments_DB = [
    ...
    "human, nature, unnatural, greedy, charity",
    "<li>If arguing greed: Anti-capitalism is the embodiment of each-to-their-own: instead of wealth concentrating to the top <1% (e.g. 1 greedy person per 100) wealth is kept individually and shared at an individual's leisure (99 greedy people).</li><li>If arguing 'forced' egalitarianism: Egalitarianism is not inherent and guarenteed by socialism - it is the will of the working class. However, humans are naturally egalitarian (charitable), as seen through governmental programmes of helping those in need (welfare, disability benefits, etc), private charity, daily social engagements, and so forth.</li>",
    "Long, sourced counter-arguments"],
    ...
    "LGBT, gay, rights, civil, homosexualality",
...
- make tags as long as possible to aid searching (greed -> greedy)
